...
function M.load()
  ...
  local groups = {
    ...
    ["@markup.strikethrough.markdown"] = { fg = c.fg_soft, strikethrough = true },
    ["@markup.strikethrough.markdown_inline"] = { fg = c.fg_soft, strikethrough = true },
    ...
    ["@markup.list.unchecked"] = { fg = c.fg_soft },
    ...
    ["@type.css"] = style({ fg = c.blue_soft }, type_style),
